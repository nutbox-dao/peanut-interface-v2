...
// PNUT_LP  
export const PNUT_TOKEN_ADDRESS = 'TDJjuVeGBtxWQPKFPuHsyD5p51scqYwiXf'
export const PNUT_POOL_ADDRESS = 'TNmgEwwkky7LyvvvLDRuvFztiyg65gi3rw'
...
export const TSTEEM_POOL_ADDRESS = 'TFccHHX5eJ6zcLa7ToYAZbn4NdAzDgFfJW'
